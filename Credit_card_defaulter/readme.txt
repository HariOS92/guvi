...
This project is to determine credit card defaulters with the data downloaded from Card Default Data (https://drive.google.com/file/d/1RqrwJqwDTeDq7sy1IWCL3Z473Z4LpwiF/view). The data is attached to repository as well.
